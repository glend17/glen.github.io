...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent() {
        ...
        this.destination = [1, 3]; //pressed stores if user is dragging any of the board elements

        this.pressed = false; //val stores clicked element value, 4 if none

        this.val = 4; //snaketiles stores values of board
      ...
      _createClass(AppComponent, [{
        key: "keepBlocks",
        value: function keepBlocks() {
          for (var i = 0; i < 10; i++) {
            for (var j = 0; j < 10; j++) {
              var _element = i.toString() + "-" + j.toString();

              if (this.snaketiles[i][j] == 5) {
                this.snaketiles[i][j] = 0;
                document.getElementById(_element).style.backgroundColor = "white";
          ...
          var element = this.startrow.toString() + "-" + this.startcol.toString();
        ...
        value: function refresh() {
          for (var i = 0; i < 10; i++) {
            ...
            for (var j = 0; j < 10; j++) {
              var element = i.toString() + "-" + j.toString();
        ...
        value: function clicked(event) {
          ...
          var row = parseInt(elementId[0]); //console.log(row);

          var col = parseInt(elementId[2]);
        ...
        value: function press(event) {
          ...
          var col = parseInt(elementId[2]); //updates val to value of pressed value in board

          this.val = this.snaketiles[row][col]; //console.log(this.val);
          ...
          if (this.val == 0 || this.val == 3) {
            ...
            //checks if val is green
            this.prevrow = row;
            this.prevcolumn = col;
            this.transferElement = elementId; //console.log(this.prevrow);
        ...
        value: function findpath() {
          var elementStr = this.pathrow.toString() + "-" + this.pathcol.toString(); //this.theQ.shift();
          //console.log(elementStr);

          document.getElementById(elementStr).style.backgroundColor = "blue";
          var ele = this.map.get(elementStr);
          console.log(ele); // clearInterval(this.intervals);
        ...
        value: function renders() {
          ...
          var rows = this.element.row;
          var cols = this.element.col;

          if (this.snaketiles[rows][cols] == 2) {
            this.snaketiles[rows][cols] = 2;

            var _elementStr = rows.toString() + "-" + cols.toString();

            this.theQ.shift(); // console.log(elementStr);

            document.getElementById(_elementStr).style.backgroundColor = "blue";
            clearInterval(this.intervals);
            this.pathrow = rows;
            this.pathcol = cols; //this.map.set((rows+1).toString+"-"+cols.toString(),elementStr);
          ...
          var elementStr = rows.toString() + "-" + cols.toString();
          this.theQ.shift(); // console.log(elementStr);
          ...
          if (cols + 1 < 10 && (this.snaketiles[rows][cols + 1] == 0 || this.snaketiles[rows][cols + 1] == 2)) {
            ...
            this.map.set(rows.toString() + "-" + (cols + 1).toString(), elementStr); // console.log(this.map.get(rows.toString+"-"+(cols+1).toString()))
          }
        }
      }, {
        key: "startSearch",
        value: function startSearch(event) {
          ...
          this.intervals = setInterval(function () {
            _this2.renders();
          }, 20); //console.log(this.theQ);
        } //mouseup event

      }, {
        key: "mouseupp",
        value: function mouseupp(event) {
          //console.log('hello');
          var elementId = event.target.id;
          var row = parseInt(elementId[0]);
          var col = parseInt(elementId[2]); // console.log('here');
        ...
        key: "mousecome",
        value: function mousecome(event) {
          //console.log('hello');
          ...
          if ((this.val == 0 || this.val == 3) && this.pressed == true && (this.snaketiles[row][col] == 0 || this.snaketiles[row][col] == 3)) {
            this.snaketiles[row][col] = 3;
            document.getElementById(elementId).style.backgroundColor = "grey"; //console.log('here');
          }
        }
      }, {
        key: "mouseleft",
        value: function mouseleft(event) {// let elementId: string = (event.target as Element).id;
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./app.component */
    "./src/app/app.component.ts"); //import { BoardComponent } from './board/board.component';
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\I533116\angular-projects\visualsearch\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
